...
**_Meltwater has added an additional argument `--fixVersion` that can be used to remidy the version issue. This additional argument will look at the value in `custom.documentation.api.verison` and use it to overwrite any version retrieved from the server. _**
